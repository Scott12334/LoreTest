...
import net.newlife.lore.entity.client.KeeperRenderer;
import net.newlife.lore.entity.client.ObsidianCreeperRenderer;
...
public class Main
{
    ...
    private void clientSetup(final FMLClientSetupEvent event){
        ...
        EntityRenderers.register(ModEntityTypes.OBSIDIAN_CREEPER.get(), ObsidianCreeperRenderer::new);

        ItemBlockRenderTypes.setRenderLayer(ModBlocks.TOMBSTONE.get(), RenderType.cutout());
    }
